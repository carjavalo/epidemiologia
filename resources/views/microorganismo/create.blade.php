...
@section('title', 'Crear Microorganismo')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-bacteria"></i> Crear Nuevo Microorganismo</h1>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-plus"></i> Nuevo Microorganismo
                    </h3>
                </div>
                <form action="{{ route('microorganismo.store') }}" method="POST" id="microorganismo-form">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary" id="submit-btn">
                                <i class="fas fa-save"></i> Crear Microorganismo
                            </button>
                        </div>
                    </div>
                </form>
