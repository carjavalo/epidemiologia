...
@section('title', 'Crear Diagnóstico Infeccioso')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-stethoscope"></i> Crear Nuevo Diagnóstico Infeccioso</h1>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-plus"></i> Nuevo Diagnóstico Infeccioso
                    </h3>
                </div>
                <form action="{{ route('diag-infeccioso.store') }}" method="POST" id="diag-infeccioso-form">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary" id="submit-btn">
                                <i class="fas fa-save"></i> Crear Diagnóstico Infeccioso
                            </button>
                        </div>
                    </div>
                </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#diag-infeccioso-form').on('submit', function(e) {
                ...
                $('#submit-btn').prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i> Creando...');
            });
