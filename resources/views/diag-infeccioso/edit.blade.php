...
@section('title', 'Editar Diagnóstico Infeccioso')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-stethoscope"></i> Editar Diagnóstico Infeccioso #{{ $diagInfeccioso->id }}</h1>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit"></i> Editar Diagnóstico Infeccioso #{{ $diagInfeccioso->id }}
                    </h3>
                </div>
                <form action="{{ route('diag-infeccioso.update', $diagInfeccioso) }}" method="POST" id="diag-infeccioso-form">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            <label for="descripcion" class="form-label required">
                                <i class="fas fa-stethoscope"></i> Descripción del Diagnóstico Infeccioso
                            </label>
                            <input type="text" 
                                   class="form-control @error('descripcion') is-invalid @enderror" 
                                   id="descripcion" 
                                   name="descripcion" 
                                   value="{{ old('descripcion', $diagInfeccioso->descripcion) }}" 
                                   placeholder="Ingrese la descripción del diagnóstico infeccioso"
                                   maxlength="150"
                                   required>
                            <div class="form-text">
                            ...
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ $diagInfeccioso->created_at->format('d/m/Y H:i') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ $diagInfeccioso->updated_at->format('d/m/Y H:i') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary" id="submit-btn">
                                <i class="fas fa-save"></i> Actualizar Diagnóstico Infeccioso
                            </button>
                        </div>
                    </div>
                </form>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#diag-infeccioso-form').on('submit', function(e) {
                ...
                if (descripcion === '') {
                    ...
                    Swal.fire({
                        ...
                        text: 'La descripción del diagnóstico infeccioso es obligatoria.'
                    });
