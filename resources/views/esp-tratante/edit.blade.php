...
@section('title', 'Editar Especialidad Tratante')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-user-md"></i> Editar Especialidad Tratante</h1>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit"></i> Editar Especialidad Tratante #{{ $espTratante->id }}
                    </h3>
                </div>
                <form action="{{ route('esp-tratante.update', $espTratante) }}" method="POST" id="esp-tratante-form">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="descripcion" 
                                   name="descripcion" 
                                   value="{{ old('descripcion', $espTratante->descripcion) }}" 
                        ...
                        <div class="alert alert-secondary">
                            ...
                            <small>
                                <strong>Creado:</strong> {{ $espTratante->created_at->format('d/m/Y H:i:s') }}<br>
                                <strong>Última actualización:</strong> {{ $espTratante->updated_at->format('d/m/Y H:i:s') }}
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <a href="{{ route('esp-tratante.show', $espTratante) }}" class="btn btn-info">
                                    <i class="fas fa-eye"></i> Ver Detalles
                                </a>
                            </div>
                            <button type="submit" class="btn btn-primary" id="submit-btn">
                                <i class="fas fa-save"></i> Actualizar Especialidad Tratante
                            </button>
                        </div>
                    </div>
                </form>
