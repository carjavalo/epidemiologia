...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-pills"></i> Editar Tratamiento #{{ $tratamiento->id }}</h1>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit"></i> Editar Tratamiento #{{ $tratamiento->id }}
                    </h3>
                </div>
                <form action="{{ route('tratamiento.update', $tratamiento) }}" method="POST" id="tratamiento-form">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            <label for="descripcion" class="form-label required">
                                <i class="fas fa-pills"></i> Descripción del Tratamiento
                            </label>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Información:</strong> La descripción debe ser única y no puede exceder los 250 caracteres.
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ $tratamiento->created_at->format('d/m/Y H:i') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ $tratamiento->updated_at->format('d/m/Y H:i') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (initialLength > 230) {
                charCount.addClass('text-danger').removeClass('text-warning');
            }

            // Validación del formulario
            $('#tratamiento-form').on('submit', function(e) {
                ...
                if (descripcion === '') {
                    ...
                    Swal.fire({
                        ...
                        text: 'La descripción del tratamiento es obligatoria.'
                    });
