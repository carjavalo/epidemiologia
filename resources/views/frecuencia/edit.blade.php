...
@section('title', 'Editar Frecuencia')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-edit"></i> Editar Frecuencia</h1>
        <div>
            <a href="{{ route('frecuencia.show', $frecuencia->id) }}" class="btn btn-info">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-chart-bar"></i> Editar Información de la Frecuencia
                    </h3>
                    <div class="card-tools">
                        <span class="badge badge-info">ID: {{ $frecuencia->id }}</span>
                    </div>
                </div>
                <form action="{{ route('frecuencia.update', $frecuencia->id) }}" method="POST" id="edit-form">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea 
                                ...
                                required>{{ old('descripcion', $frecuencia->descripcion) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $frecuencia->created_at_formatted }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><i class="fas fa-calendar-check"></i> Última Actualización</label>
                                    <input type="text" class="form-control" value="{{ $frecuencia->updated_at_formatted }}" readonly>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary" id="submit-btn">
                                <i class="fas fa-save"></i> Actualizar Frecuencia
                            </button>
                        </div>
                    </div>
                </form>
        ...
        $(document).ready(function() {
            ...
            $('#edit-form').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    text: '¿Deseas actualizar la información de esta frecuencia?',
                    icon: 'question',
