...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-chart-bar"></i> Frecuencia</h1>
        <a href="{{ route('frecuencia.create') }}" class="btn btn-primary">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="frecuencias-table" class="table table-bordered table-striped table-hover">
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            const table = $('#frecuencias-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: {
                    url: '{{ route("frecuencia.index") }}',
                    type: 'GET',
