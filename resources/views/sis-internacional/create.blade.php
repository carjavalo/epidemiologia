...
@section('title', 'Crear Sistema Internacional')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-plus"></i> Crear Sistema Internacional</h1>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <form action="{{ route('sis-internacional.store') }}" method="POST" id="create-form">
                    @csrf
                    <div class="card-body">
