...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-vial"></i> Crear Nuevo Tipo de Muestra</h1>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-plus"></i> Crear Nuevo Tipo de Muestra
                    </h3>
                </div>
                <form action="{{ route('tip-muestra.store') }}" method="POST" id="tip-muestra-form">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary" id="submit-btn">
                                <i class="fas fa-save"></i> Guardar Tipo de Muestra
                            </button>
                        </div>
                    </div>
                </form>
