...
@section('title', 'Editar Perfil Antimicrobiano')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-shield-virus"></i> Editar Perfil Antimicrobiano</h1>
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit"></i> Editar Perfil Antimicrobiano #{{ $pantimicrobiano->id }}
                    </h3>
                </div>
                <form action="{{ route('pantimicrobiano.update', $pantimicrobiano) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="descripcion" 
                                   name="descripcion" 
                                   value="{{ old('descripcion', $pantimicrobiano->descripcion) }}" 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <small class="text-muted">
                                        <strong>Creado:</strong> {{ $pantimicrobiano->created_at->format('d/m/Y H:i:s') }}
                                    </small>
                                </div>
                                <div class="col-md-6">
                                    <small class="text-muted">
                                        <strong>Actualizado:</strong> {{ $pantimicrobiano->updated_at->format('d/m/Y H:i:s') }}
                                    </small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Actualizar Perfil Antimicrobiano
                            </button>
                        </div>
                    </div>
                </form>
