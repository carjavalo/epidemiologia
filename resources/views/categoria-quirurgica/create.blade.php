...
@section('title', 'Nueva Categoría Quirúrgica')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-procedures"></i> Nueva Categoría Quirúrgica</h1>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-plus"></i> Crear Nueva Categoría Quirúrgica</h3>
                </div>
                <form action="{{ route('categoria-quirurgica.store') }}" method="POST" id="categoria-quirurgica-form">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary" id="submit-btn">
                                <i class="fas fa-save"></i> Guardar Categoría Quirúrgica
                            </button>
                        </div>
                    </div>
                </form>
