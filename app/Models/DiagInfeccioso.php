...
class DiagInfeccioso extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'diag_infecciosos';
    ...
    public static function rules($id = null): array
    {
        return [
            'descripcion' => [
                ...
                'string',
                'max:150',
                'unique:diag_infecciosos,descripcion,' . $id,
            ],
        ];
    }
    ...
    public static function messages(): array
    {
        return [
            ...
            'descripcion.unique' => 'Ya existe un diagnóstico infeccioso con esta descripción.',
        ];
    }
