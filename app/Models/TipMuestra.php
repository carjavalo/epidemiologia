...
class TipMuestra extends Model
{
    /**
    ...
    public static function rules($id = null): array
    {
        return [
            'descripcion' => [
                ...
                'string',
                'max:150',
                'unique:tip_muestras,descripcion,' . $id,
            ],
        ];
    }
    ...
    public static function messages(): array
    {
        return [
            ...
            'descripcion.unique' => 'Ya existe un tipo de muestra con esta descripción.',
        ];
    }
